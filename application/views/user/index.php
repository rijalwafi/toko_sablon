...
<div class="row dashboard">
    ...
    <div id="modalKaryawan" class="modal modal-fixed-footer">
        <form action="<?= base_url('user/add_user_admin') ?>" method="post">
            <div class="modal-content">
                ...
                <div class="row">
                    <div class="col s12">
                        ...
                        <div class="col s6">
                            <select name="level_user" id="level_user" <option value="">Level User</option>
            ...
            <div class="modal-footer">
                <button type="submit" class="modal-close waves-effect waves-green btn-flat blue lighten-1"
                    onclick="M.toast({html: 'pendaftaran berhasil'})">Confirm</button>
                ...
                <div class="row">
                    <div class="col s12">
                        <div class="row">
                            ...
                            <div class="input-field col s6">
                                <i class="material-icons prefix">account_circle</i>
                                <input id="username" name="username" type="text" value="<?= $tb_user['username'];?>"
                                    class="validate" />
                                <label for="username">Username</label>
                            </div>
                            <div class="input-field col s6">
                                <i class="material-icons prefix">home</i>
                                <input id="address" name="address" value="<?= $tb_user['address'] ?>" type="text"
                                    class="validate" />
                                <label for="address">Address</label>
                            </div>
                        </div>
                        ...
                        <div class="col s6">
                            <select name="gender" id="gender">
                                ...
                                <option value="Pria" <?php echo ($tb_user['gender'] == 'Pria' ? ' selected' : ''); ?>>
                                    Pria</option>
                                <option value="Wanita"
                                    <?php echo ($tb_user['gender'] == 'Wanita' ? ' selected' : ''); ?>>Wanita</option>
                            </select>
                        </div>
                        <div class="col s6">
                            <select name="level_user" id="level_user">
                                ...
                                <option value="owner"
                                    <?php echo ($tb_user['level_user'] == 'owner' ? ' selected' : ''); ?>>owner</option>
                                <option value="karyawan"
                                    <?php echo ($tb_user['level_user'] == 'karyawan' ? ' selected' : ''); ?>>karyawan
                                </option>
                                <option value="konsumen"
                                    <?php echo ($tb_user['level_user'] == 'konsumen' ? ' selected' : ''); ?>>Customer
                                </option>
                            </select>
                        </div>
                        <div class="row">
                            <div class="input-field col s6">
                                <i class="material-icons prefix">contact_phone</i>
                                <input id="phone_number" name="phone_number" value="<?= $tb_user['phone_number'] ?>"
