...
<div class="row dashboard">
    ...
    <div id="modalKaryawan" class="modal modal-fixed-footer">
        <form action="<?= base_url('konsumen/add_user') ?>" method="post">
    ...
    <div id="modalEditKaryawan<?= $tb_user['id_user'] ?>" class="modal modal-fixed-footer">
        <form action="<?php echo base_url('user/edit_user_kustomer') ?>" method="post">
            <div class="modal-content">
                        ...
                        <div class="col s6">
                            <select name="level_user" id="level_user">
                                ...
                                <option value="konsumen"
                                    <?php echo ($tb_user['level_user'] == 'konsumen' ? ' selected' : ''); ?>>konsumen
                                </option>
                            </select>
                        </div>
                        <div class="row">
