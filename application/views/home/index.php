        ...
        <div class="col s12 m4">
          <div class="card">
            <div class="card-image">
              <img
                src="<?php echo base_url('assets/image/').$tb_product['image'] ?>"
                alt="galon aqua"
                class="i responsive-img"
            ...
            <div class="card-content">
              <span
                ...
                <button
                  class="bt btn-floating medium right red modal-trigger"
                  data-target="mod1<?= $tb_product['id_product'] ?>"
                ...
                <div id="mod1<?= $tb_product['id_product'] ?>" class="modal modal-fixed-footer">
                        ...
                        <ul class="collapsible">
                          ...
                          <li>
                            ...
                            <div class="co collapsible-header">
                             ...
                             <!-- <input type="hidden" name="selling_price" id="selling_price" value="<?= $tb_product['selling_price'] ?>" placeholder="Jumlah Beli"  > -->
                          ...
                          <li>
                             <!-- <div class="co collapsible-header">
                             <input type="text" name="total_beli" id="total_beli" placeholder="total harga"  >
                  ...
                  <div class="modal-footer">
                    <a
                      ...
                      class="modal-close waves-effect waves-green btn-flat blue lighten-1" href="<?= base_url('home/sukses/').$tb_product['id_product'];?>"
                      >Beli</a>
                    <a
