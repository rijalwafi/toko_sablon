        ...
        <nav>
            <div class="nav-wrapper grey accent-1">
                <a class="brand-logo" style="margin-left: 20px;">
                    Administrator <span class="black-text lighten-2"> </span>
                </a>
        ...
        <ul>
            ...
            <li <?= $menu_manajemen_user; ?>
                ...
                <ul id="demo">
                    <li>
                        <a href="<?= site_url('user/p') ?>">
                            <span class="material-icons sub-icon">person_add</span>Karyawan</a>
                    </li>
                    <li>
            ...
            <li <?= $menu_produk; ?>
                <?= $this->uri->segment(1) == 'produk' || $this->uri->segment(1) == '' ? 'class="active"' : '' ?>>
            ...
            <li <?= $menu_pembayaran; ?>
                <?= $this->uri->segment(1) == 'pembayaran' || $this->uri->segment(1) == '' ? 'class="active"' : '' ?>>
                <a href="<?= site_url('pembayaran/p') ?>">
                    <span class="material-icons icon">payment</span>
                    <span class="title">Kelola Pembayaran</span>
                </a>
            </li>
            <li <?= $menu_penjualan; ?>
                <?= $this->uri->segment(1) == 'penjualan' || $this->uri->segment(1) == '' ? 'class="active"' : '' ?>>
            ...
            <li <?= $menu_laporan; ?>
                <?= $this->uri->segment(1) == 'laporan' || $this->uri->segment(1) == '' ? 'class="active"' : '' ?>>
