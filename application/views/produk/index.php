        ...
        <form action="<?= base_url('produk/add_produk') ?>" enctype="multipart/form-data" method="post">
                        ...
                        <div class="row">
                          ...
                          <!--   <div class="input-field col s6">
                            ...
                            <div class="input-field col s8">
                                <textarea id="keterangan" name="keterangan" class="materialize-textarea" width="500"
            ...
            <div class="modal-footer">
                <button type="submit" class="modal-close waves-effect waves-green btn-flat blue lighten-1"
                    onclick="M.toast({html: 'Tambah produk berhasil'})">Confirm</button>
        ...
        <form action="<?php echo base_url('produk/edit_produk') ?>" enctype="multipart/form-data" method="post">
            <div class="modal-content">
                ...
                <div class="row">
                    <div class="col s12">
                        <div class="row">
                            <input type="hidden" readonly value="<?= $tb_produk['id_product'];?>" name="id_product"
                                id="id_product" class="form-control">
                            <div class="input-field col s6">
                                <i class="material-icons prefix">account_circle</i>
                                <input id="name_product" name="name_product" type="text"
                                    value="<?= $tb_produk['name_product'];?>" class="validate" />
                                <label for="name_product">Name Produk</label>
                            </div>
                            <div class="input-field col s6">
                                <i class="material-icons prefix">home</i>
                                <input id="purchase_price" name="purchase_price"
                                    value="<?= $tb_produk['purchase_price'] ?>" type="text" class="validate" />
                                <label for="purchase_price">Purchase Price</label>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="input-field col s6">
                                <i class="material-icons prefix">contact_phone</i>
                                <input id="stock_product" name="stock_product"
                                    value="<?= $tb_produk['stock_product'] ?>" type="number" class="validate" />
                                <label for="stock_product">Stock</label>
                            </div>
                            <div class="input-field col s6">
                                <i class="material-icons prefix">contact_phone</i>
                                <input id="selling_price" name="selling_price"
                                    value="<?= $tb_produk['selling_price'] ?>" type="number" class="validate" />
                                <label for="selling_price">Selling Price</label>
                            </div>
                          <!--   <div class="input-field col s6">
                                ...
                                <select name="size" id="size">
                                    <option value="" selected disabled>Ukuran</option>
                                    <option value=" M" <?php echo ($tb_produk['size'] == 'M' ? ' selected' : ''); ?>>M
                                    </option>
                                    <option value="L" <?php echo($tb_produk['size']=='L'?'selected':'');?>>L</option>
                                    <option value="XL" <?php echo($tb_produk['size']=='XL'?'selected':'');?>>XL</option>
                                    <option value="XXL" <?php echo($tb_produk['size']=='XXL'?'selected':'');?>>XXL
                                    </option>
                            ...
                            <div class="file-field input-field col s6">
                                ...
                                <input type="hidden" name="current_image" id="current_image"
                                    value="<?= $tb_produk['image'] ?>">
                                <div class="file-path-wrapper">
                                    <input class="file-path validate" type="text" value="<?= $tb_produk['image'] ?>">
                                    <label for="image">Masukan Gambar</label>
                                </div>
                            </div>
                            <div class="input-field col s8">
                                <textarea id="keterangan" name="keterangan"
                                    class="materialize-textarea "><?= $tb_produk['keterangan'] ?></textarea>
        ...
        <table class="striped" id="myTable">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td hidden><?=$tb_produk['keterangan']?></td>
                    <td><img src="<?= base_url('assets/image/').$tb_produk['image'] ?>" style="width: 60px;" alt="">
                    </td>
                    <td>
                        <span>
                            <div class="btn-floating btn-small red darken-5 tooltipped" data-tooltip="Edit data produk">
                                <a href="#modalEditKaryawan<?= $tb_produk['id_product'] ?>"
